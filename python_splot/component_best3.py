...
def compbest3(nout,data,icomp,write=True,internal_energy_fraction=0.):
    global firstt
...
>>>>>>> 706dca6185b661b857fdf6d3337257d9d53c74ff
    ...
    print("parent star numbers =", number1, number2)
    if number1 == 2:
        print(f'NOTE: LARGEST DENSITY PARTICLE IN COMPONENT 1 COMES FROM PARENT 2')
    if number2 == 1:
        print(f'NOTE: LARGEST DENSITY PARTICLE IN COMPONENT 2 COMES FROM PARENT 1')
    #raise SystemExit
...
>>>>>>> 706dca6185b661b857fdf6d3337257d9d53c74ff
        ...
        #valid_condition_1 = valid_bi1 & ((bi2 >= 0) | (bi1 < bi2)) & ((bi3 >= 0) | (bi1 < bi3))
        #valid_condition_2 = valid_bi2 & ((bi1 >= 0) | (bi2 < bi1)) & ((bi3 >= 0) | (bi2 < bi3))
        #valid_condition_3 = valid_bi3 & ((bi1 >= 0) | (bi3 < bi1)) & ((bi2 >= 0) | (bi3 < bi2))
...
#        icomp = ic  # Update the icomp array with the new assignments
    ...
    print(f"positions at nout={nout}: {r1}, {r2}")
    ...
    if write:
        ...
        with open(f"masses_{internal_energy_fraction}.sph", 'a') as f:
            f.write(f'{nout} {am1} {am2} {am3} {am4}\n')
